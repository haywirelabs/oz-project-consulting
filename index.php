    ...
    <div id="wrap">
        <div class="container">
            ...
            <div class="content-summary">
                ...
                <p>I have extensive experience as an individual contributor, a team leader, and a project manager. I&#39;ve worked as a System Engineer, a System Integrator, an Operations Manager, a Hardware Engineer, a Systems Administrator, a Hardware technician, a Video Producer and trainer, and a US Navy enlisted Chief Electronics Technician ashore, abroad, and afloat as a Division Chief, a Leading Petty Officer (LPO), a Work Center Supervisor, instructor, and a technician.</p>
                ...
                <table class="table table-condensed table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>11/2010 - Present</td>

                            <td>Systems Engineer Senior Staff</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>01/2001 - 07/2004</td>

                            <td>Systems Engineer Senior Staff</td>
                        </tr>

                        <tr>
                            <td>Lockheed-Martin Technical Operations</td>

                            <td>Newington, VA</td>

                            <td>01/2000 - 01/2001</td>
                        ...
                        <tr>
                            ...
                            <td>04/1995 - 06/2000</td>

                            <td>Operations Manager</td>
                        </tr>

                        <tr>
                            <td>Norwest Mortgage/Wells Fargo</td>

                            <td>Frederick, MD</td>

                            <td>03/1998 - 08/1999</td>

                            <td>Technical Supervisor I</td>
                        </tr>

                        <tr>
                            <td>Lockheed Technical Operations</td>

                            <td>Reston, VA</td>

                            <td>05/1993 - 06/1995</td>

                            <td>Field Engineer</td>
                        </tr>

                        <tr>
                            <td>Lockheed Missiles and Space</td>

                            <td>Reston, VA</td>

                            <td>03/1989 - 05/1993</td>
                        ...
                        <tr>
                            ...
                            <td>12/1975 - 03/1986</td>

                            <td>Chief Electronics Technician (E7)</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="content-contract">
                ...
                <div id="idex-detail" class="content-contract-detail well well-sm collapse">
                    <ul>
                        ...
                        <li>Performed network management and support for a wide array of client/server sub-systems.</li>
            ...
            <div class="content-contract">
                ...
                <div id="navy-detail" class="content-contract-detail well well-sm collapse">
                    <ul>
                        ...
                        <li>Returning to the US, I filled an instructor duty billet which consisted of extensive curriculum re-development moving from analog electronics and systems to digital electronics and systems. Also, for a long period I was the remedial education supervisor working closely with students who were struggling academically.</li>
                        ...
                        <li>Principle hardware systems supported included (in chronological order) AN/WSC-3 (NEC 1425), various analog crypto, AN/URT-23 (and AN/URT-23C), AN/FRC-84 microwave transceivers and corresponding Frequency Division Multiplexing (FDM) baseband systems, FFG-7 class communications systems, NAVMACSv3 (NEC 1452), AN/SPS-49 (NEC 1503), AN-SPS-55 (NEC 1504), Navy Tactical Data Systems (NTDS) components, LAMPS Mk 3 components. Single Audio System (SAS). Frequent domestic and International travel as well as deployments afloat.</li>

                        <li>Duty Stations:

                            <ul>
                                <li>Boot Camp - Orlando, FL</li>

                                <li>Electronics Tech. "A" School - Great Lakes, IL (student)</li>

                                <li>Electronics Tech. "C" School - San Diego, CA (student)</li>

                                <li>Naval Communications Station San Miguel, RP - Subic/Cubi Pt, RP</li>

                                <li>Electronics Tech "A" School - Great Lakes, IL (instructor)</li>

                                <li>Electronics Tech "C" School - Norfolk, VA (student)</li>

                                <li>USS Curts FFG-38 plank-owner - Long Beach, CA</li>

                                <li>Mobile Technical Unit (MOTU-11) Long Beach, CA</li>
                            </ul>
                        </li>
                    </ul>
                </div>
